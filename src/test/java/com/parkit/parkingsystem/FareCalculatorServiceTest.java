...
public class FareCalculatorServiceTest {
    ...
    public void calculateFareCarWithLessThan30minutesParkingTimeDescription(){
    	...
    	Date inTime = new Date();
    	inTime.setTime(System.currentTimeMillis() - (30 * 60 * 1000));//30 minutes or less parking time should give free fare 
    	Date outTime = new Date();
    	ParkingSpot parkingSpot = new ParkingSpot(1, ParkingType.CAR,false);
    ...
    public void calculateFareCarWithDiscountDescription(){
    	...
    	Date inTime = new Date();
    	inTime.setTime(System.currentTimeMillis() - (60 * 60 * 1000)); //1 hour parking with a discount ticket should paye 95% of the price
    	Date outTime = new Date();
    	ParkingSpot parkingSpot = new ParkingSpot(1, ParkingType.CAR, false);
    ...
    public void calculateFareBikeWithDiscountDescription() {
    	...
    	assertEquals(ticket.getPrice(), Math.round((0.95 * Fare.BIKE_RATE_PER_HOUR) * Math.pow(10, 3)) / Math.pow(10, 3));
